...
-- ========================
-- TABELA: Voluntário x Especialidade
-- ========================
CREATE TABLE voluntario_especialidade (
    ...
    CONSTRAINT fk_ve_voluntario FOREIGN KEY (fk_voluntario) REFERENCES voluntario(id_voluntario) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT fk_ve_especialidade FOREIGN KEY (fk_especialidade) REFERENCES especialidade(id_especialidade) ON DELETE CASCADE ON UPDATE CASCADE
);
