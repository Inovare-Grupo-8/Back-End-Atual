...
public class VoluntarioDadosProfissionaisInputDTO {
    ...
    public VoluntarioDadosProfissionaisInputDTO() {}

    public VoluntarioDadosProfissionaisInputDTO(Funcao funcao, String registroProfissional, String biografiaProfissional,
