...
@Data
public class UsuarioDetalhesOutputDTO implements UserDetails {
    private static final long serialVersionUID = 3939036964410265319L;
    private static final Logger LOGGER = LoggerFactory.getLogger(UsuarioDetalhesOutputDTO.class);
    ...
    public UsuarioDetalhesOutputDTO(Usuario usuario, Ficha ficha) {
