...
public class SalvarFotoUseCaseImpl implements SalvarFotoUseCase {
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(SalvarFotoUseCaseImpl.class);
    ...
    public String salvarFoto(Integer usuarioId, String tipo, MultipartFile file) throws IOException {
        ...
        String fotoUrl = fotoUseCase.salvarFoto(tipo, usuarioId, file);
