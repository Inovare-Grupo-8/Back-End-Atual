...
public class CadastrarUsuarioSegundaFaseUseCaseImpl implements CadastrarUsuarioSegundaFaseUseCase {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CadastrarUsuarioSegundaFaseUseCaseImpl.class);
    ...
    public UsuarioOutput executar(Integer idUsuario, UsuarioInputSegundaFase usuarioInputSegundaFase) {
        ...
        // Processar funcao se fornecida e tipo for VOLUNTARIO
        if (usuarioInputSegundaFase.getFuncao() != null && usuario.getTipo() == org.com.imaapi.domain.model.enums.TipoUsuario.VOLUNTARIO) {
        ...
        LOGGER.info("Cadastro da segunda fase concluído para usuário ID: {}", idUsuario);
        
        // Construir e retornar o output completo
        return construirUsuarioOutput(usuario, ficha, enderecoOutput, telefoneOutput, usuarioInputSegundaFase.getFuncao());
    }
    ...
    private UsuarioOutput construirUsuarioOutput(Usuario usuario, Ficha ficha, EnderecoOutput enderecoOutput, TelefoneOutput telefoneOutput, org.com.imaapi.domain.model.enums.Funcao funcaoInput) {
        ...
        // Definir funcao baseado no input ou buscar do voluntário
        if (funcaoInput != null) {
            output.setFuncao(funcaoInput);
        } else if (usuario.getTipo() != null && usuario.getTipo().toString().equals("VOLUNTARIO")) {
            Voluntario voluntario = voluntarioRepository.findByUsuario_IdUsuario(usuario.getIdUsuario());
            if (voluntario != null) {
