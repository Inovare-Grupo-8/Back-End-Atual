...
import org.com.imaapi.application.Usecase.Consulta.mapper.ConsultaMapper;
...
public class ConsultaServiceImpl implements ConsultaService {
    ...
    public ResponseEntity<ConsultaOutput> criarEvento(ConsultaRequestDTO consultaInput) {
        try {
    ...
    private Consulta gerarObjetoEvento(ConsultaRequestDTO consultaInput) {
        try {
   ...
   public ResponseEntity<ConsultaOutput> getProximaConsulta(Integer idUsuario) {
    ...
    @Override
    public void remarcarConsulta(Integer id, ConsultaRemarcarRequestDTO input) {
