...
public class EnderecoController {
    ...
    @GetMapping("/cep/{cep}")
    @Operation(summary = "Buscar endereço por CEP", description = "Busca informações de endereço através do CEP")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Endereço encontrado com sucesso",
                    content = @Content(mediaType = "application/json", schema = @Schema(implementation = EnderecoOutput.class))),
    ...
    public ResponseEntity<EnderecoOutput> buscarEnderecoPorCep(@PathVariable String cep,
        ...
        EnderecoOutput endereco = buscarEnderecoPorCepUseCase.buscarEnderecoPorCep(cep, numero, complemento);
